...
// 📝 Answer: The data will be appended to the URL as query parameters. 
...
// 📝 Answer: The sent data will be included in the request payload in the Network tab of the browser's developer tools
...
console.log(marioGameJson);  // the nested objects will also be converted to JSON format.
